                        ...
                        <div className="divide-y divide-slate-100 dark:divide-slate-700/50">
                            {filteredFiles.map((file, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className={`group relative py-3 md:py-4 px-4 md:px-6 hover:bg-slate-50/80 dark:hover:bg-slate-700/30 transition-all duration-300 ${isDark ? 'bg-slate-800' : 'bg-white'
                                            }`}
                                    >
                                        ...
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                            ...
                                            <div className="flex items-center gap-2 w-full md:w-auto md:ml-4 mt-3 md:mt-0">
                                                <a
                                                    href={downloadLink}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className={`flex-1 md:flex-none inline-flex items-center justify-center gap-2 px-4 md:px-5 py-3 md:py-2.5 rounded-xl font-bold text-sm transition-all duration-300 shadow-sm hover:shadow-lg active:scale-95 min-h-[44px] ${isDark
                                                ...
                                                <button
                                                    ...
                                                    className={`inline-flex items-center justify-center p-3 md:p-2.5 rounded-xl transition-all duration-300 border min-h-[44px] min-w-[44px] ${isDark
