                            ...
                            {paginatedFiles.map((file, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-1 md:gap-4 w-full overflow-hidden">
                                            <div className="flex-1 min-w-0 flex items-center gap-1.5 md:gap-4 overflow-hidden">
                                                ...
                                                <div className="flex-1 min-w-0 overflow-hidden">
                                                    {/* File name - %30 smaller on mobile (12px * 0.7 = 8.4px, rounded to 9px for readability) */}
                                                    <h3 className={`font-semibold md:font-bold text-[9px] md:text-sm leading-tight line-clamp-2 md:truncate break-words ${isDark ? 'text-white' : 'text-slate-900'}`}>
                                                        {file.fileName}
                                                    </h3>
                                                    ...
                                                    <div className="flex items-center gap-1.5 md:gap-2 mt-0.5 md:mt-1 flex-wrap">
                                                        <span className={`inline-flex items-center gap-1 px-1.5 md:px-2 py-0.5 rounded-md text-[7px] md:text-xs font-bold uppercase tracking-tight ${isDark
                                                        ...
                                                        <span className={`text-[7px] md:text-xs font-medium whitespace-nowrap ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                                                            {formatFileSize(file.size)}
                                                        </span>
                                                        {/* Dosya uzantısı - sadece mobilde, daha kompakt */}
                                                        <span className={`md:hidden text-[7px] font-medium px-1 py-0.5 rounded ${isDark ? 'bg-slate-700/30 text-slate-400' : 'bg-slate-100 text-slate-500'}`}>
                                            ...
                                            {/* Action buttons - closer to filename on mobile */}
