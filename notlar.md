...
-admin sayfasında risk önerileri - adminin girdiği panel sayfasına taşınacak
-öneri risk silince kullanıcıdan da silinmesin istiyoruz. kontrol edilecek test et
-panelde ki premium deneme kartı ğst kısımdaki navbarın içine alınacak
-kullanıcı giriş yaptıktan sonra panel sayfasına yönlendirsin
